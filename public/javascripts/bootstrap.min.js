        ...
        var e = "modal",
          ...
          v = (function() {
            ...
            return (h.prototype.toggle = function(t) {
              ...
              (t.className = m.SCROLLBAR_MEASURER), document.body.appendChild(
                t
              );
          ...
          m = (function() {
            function h(e, i) {
              ...
              n(this, h), (this._element = e), (this._scrollElement =
                "BODY" === e.tagName
                  ? window
                  : e), (this._config = this._getConfig(i)), (this._selector =
                this._config.target +
                " " +
                g.NAV_LINKS +
                "," +
              ...
              if (
                ...
                a &&
                  t(a)
                    ...
                    .addClass(d.ACTIVE), e.setAttribute("aria-expanded", !0);
              }
              o && o();
            }), (e._jQueryInterface = function(n) {
              return this.each(function() {
            ...
            return (h.prototype.enable = function() {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                t(o).data(this.constructor.DATA_KEY, this).appendTo(c), t(
                  ...
                  addTargetClasses: !1
                })), r.reflow(o), this._tether.position(), t(o).addClass(
                  m.SHOW
                );
                var d = function() {
                  var n = e._hoverState;
              ...
              if (
                ...
                return clearTimeout(n._timeout), (n._hoverState = g.OUT), n
