...
!(function(a, b) {
    ...
    function(a, b) {
      r.fn[a] = function(c, d) {
        ...
        return "Until" !== a.slice(-5) && (d = c), d &&
          ...
          (I[a] || r.uniqueSort(e), H.test(a) && e.reverse()), this.pushStack(
          e
        );
      };
    }
  ...
  (ka.optgroup =
    ka.option), (ka.tbody = ka.tfoot = ka.colgroup = ka.caption = ka.thead), (ka.th = ka.td);
  function la(a, b) {
    var c =
    ...
    for (
      ...
      if (((f = a[n]), f || 0 === f))
        if ("object" === r.type(f)) r.merge(m, f.nodeType ? [f] : f);
          ...
          (g = g || l.appendChild(b.createElement("div"))), (h = (ia.exec(
            f
          ) || ["", ""])[1]
  ...
  (r.event = {
    ...
    add: function(a, b, c, d, e) {
      ...
      if (q) {
        c.handler && ((f = c), (c = f.handler), (e = f.selector)), e &&
          r.find.matchesSelector(pa, e), c.guid || (c.guid = r.guid++), (i =
    ...
    preventDefault: function() {
      ...
      (this.isDefaultPrevented = ta), a &&
        !this.isSimulated &&
        a.preventDefault();
    },
    stopPropagation: function() {
      var a = this.originalEvent;
      (this.isPropagationStopped = ta), a &&
        !this.isSimulated &&
        a.stopPropagation();
    },
    stopImmediatePropagation: function() {
      var a = this.originalEvent;
      (this.isImmediatePropagationStopped = ta), a &&
        !this.isSimulated &&
    ...
    off: function(a, b, c) {
      ...
      return (b !== !1 && "function" != typeof b) ||
        ((c = b), (b = void 0)), c === !1 && (c = ua), this.each(function() {
  ...
  function Ha(a, b, c, d) {
    ...
    if (
      ...
      for (h = r.map(la(e, "script"), Da), i = h.length; m > l; l++)
        (j = e), l !== n &&
          ((j = r.clone(j, !0, !0)), i && r.merge(h, la(j, "script"))), c.call(
          a[l],
          j,
          l
        );
  ...
  function Ia(a, b, c) {
    for (var d, e = b ? r.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
      c || 1 !== d.nodeType || r.cleanData(la(d)), d.parentNode &&
        (
  ...
  r.extend({
    ...
    clone: function(a, b, c) {
      ...
      return (g = la(h, "script")), g.length > 0 &&
        ma(g, !i && la(a, "script")), h;
    },
  ...
  function Va(a, b, c, d, e) {
    for (
      ...
      "margin" === c && (g += r.css(a, c + aa[f], !0, e)), d
        ? (
    ...
    style: function(a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        var e,
          ...
          h = r.camelCase(b),
          i = a.style;
        return (b = r.cssProps[h] || (r.cssProps[h] = Ta(h) || h)), (g =
    ...
    r.cssHooks[b] = {
      ...
      set: function(a, c, d) {
        ...
        return g &&
          (e = _.exec(c)) &&
          "px" !== (e[3] || "px") &&
          ((a.style[b] = c), (c = r.css(a, b))), Ua(a, c, g);
      }
    };
    ...
    propHooks: {
      tabIndex: {
        get: function(a) {
          ...
          return b
            ? parseInt(b, 10)
            : Za.test(a.nodeName) || ($a.test(a.nodeName) && a.href) ? 0 : -1;
        }
      }
    },
