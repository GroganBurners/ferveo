!(function(t, e) {
  ...
  function r(t) {
    ...
    ), t.ownerDocument !== document && i.push(t.ownerDocument.defaultView), i;
  }
  function s() {
    ...
    return o.forEach(function(e) {
      ...
      "string" == typeof o &&
        (o = parseFloat(
          o,
          10
        )), "string" == typeof i && (i = parseFloat(i, 10)), (t.top += o), (t.left += i);
    }), t;
  }
  function C(t, e) {
            ...
            if ("undefined" != typeof this.bindings && this.bindings[t]) {
              ...
              for (; e < this.bindings[t].length; ) {
                var r = this.bindings[t][e],
                  ...
                  f = r.once,
                  l = a;
                "undefined" == typeof l && (l = this), s.apply(l, i), f
  ...
  var F = { center: "center", left: "right", right: "left" },
    ...
    V = function(t) {
      var e = t.left,
        o = t.top;
      return "undefined" != typeof N[t.left] && (e = N[t.left]), "undefined" !=
        typeof N[t.top] && (o = N[t.top]), { left: e, top: o };
    },
    R = function(t) {
      var e = t.split(" "),
        o = z(e, 2),
    ...
    I = (function(t) {
      function e(t) {
        ...
        i(this, e), j(
          ...
          "constructor",
          this
        ).call(this), (this.position = this.position.bind(this)), D.push(
          this
        ...
        },
        {
          ...
          value: function(t) {
            ...
            (this.targetAttachment = q(
              ...
              this.options.attachment
            )), (this.offset = R(this.options.offset)), (this.targetOffset = R(
          ...
          value: function() {
            ...
            if (this.enabled) {
              ...
              return T.innerHeight > A.documentElement.clientHeight &&
                ...
                ["", "static"].indexOf(A.body.parentElement.style.position) !==
                  -1) ||
                (
                ...
                d = function(t, o) {
                  ...
                  if (n !== !1) {
                    ...
                    (l[L] =
                      ...
                      "px) translateY(" +
                      r +
                      "px)"), "msTransform" !== L && (l[L] += " translateZ(0)");
                  } else
                    t.top
                      ? (l.top = o.top + "px")
  ...
  x.modules.push({
    position: function(t) {
      ...
      return p.push(this.getClass("abutted")), c.forEach(function(t) {
        ...
        e.options.addTargetClasses !== !1 &&
          m(e.target, u, p), m(e.element, u, p);
      }), !0;
    }
  });
  var z = (function() {
